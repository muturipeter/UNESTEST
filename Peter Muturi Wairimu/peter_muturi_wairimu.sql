...
--
ALTER TABLE `alphabets`
  ADD CONSTRAINT `user_relation` FOREIGN KEY (`id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
